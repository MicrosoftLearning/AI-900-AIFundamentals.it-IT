...
1. Nello studio di Azure Machine Learning fare clic su **Manage preview features** (Gestisci funzionalità anteprima) (icona dell'altoparlante - &#128363;).

    ![Screenshot del pulsante Manage preview features (Gestisci funzionalità anteprima) nel menu.](../instructions/media/use-automated-machine-learning/severless-compute-1.png)

1. Abilita le seguenti funzionalità di anteprima:

    - *Esperienza guidata per l'invio di processi di training con elaborazione serverless*
...
1. Creare un nuovo processo di Machine Learning automatizzato con le impostazioni seguenti, usando **Avanti** come necessario per avanzare tramite l'interfaccia utente:
   ...
   **Tipo di attività e dati**:
    ...
    - **Selezionare il set di dati**: creare un nuovo set di dati con le impostazioni seguenti:
        ...
        Selezionare il set di dati **bike-rentals** (noleggi di biciclette) dopo averlo creato.
    ...
    **Impostazioni attività**:
    ...
    - **Limiti**: *espandere questa sezione*
        ...
        - **Soglia di punteggio metrica**: 0,85 (*in modo che se un modello raggiunge un punteggio della metrica Radice normalizzata dell'errore quadratico medio di 0,085 o inferiore, il processo termina.*)
        - **Timeout**: 15
